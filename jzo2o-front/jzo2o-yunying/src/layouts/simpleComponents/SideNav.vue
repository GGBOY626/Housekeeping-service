...
import { getActivePath, getRoutesExpanded } from '@/router'
...
const active = computed(() => {
  return getActivePath(route.value)
})
// 展开的菜单
const defaultExpanded = computed(() => {
  const path = getActivePath(route.value)
