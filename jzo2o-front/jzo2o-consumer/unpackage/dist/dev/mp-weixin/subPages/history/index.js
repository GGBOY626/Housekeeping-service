  ...
  setup(__props, { emit: __emit }) {
    ...
    const getNewData = async (time) => {
      ...
      await pages_api_order.getHistoryOrder(params).then((res) => {
        ...
        common_vendor.index.__f__("log", "at subPages/history/index.vue:258", err);
      });
    };
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        h: common_vendor.sr(gscosmosDateSelect, "3a5c8335-2", {
          "k": "gscosmosDateSelect"
        }),
        i: common_vendor.o(bindStartDateChange),
        ...
        l: common_vendor.sr(gscosmosDateSelect, "3a5c8335-3", {
          "k": "gscosmosDateSelect"
        }),
        m: common_vendor.o(bindEndDateChange),
        ...
        q: common_vendor.t(startTime.value || "开始时间"),
        r: common_vendor.o(handleStartTime),
        s: common_vendor.t(endTime.value || "结束时间"),
        t: common_vendor.o(handleEndTime),
        v: common_vendor.o(handleReset),
        w: common_vendor.o(searchDataByTime),
        x: common_vendor.sr(popup, "3a5c8335-4", {
          "k": "popup"
        }),
        y: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-3a5c8335"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/subPages/history/index.js.map
