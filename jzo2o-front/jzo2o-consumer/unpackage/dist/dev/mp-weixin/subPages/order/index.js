  ...
  setup(__props) {
    ...
    const getNewData = async (type) => {
      ...
      await pages_api_order.getOrderScroll(params).then((res) => {
        ...
        common_vendor.index.__f__("log", "at subPages/order/index.vue:135", err);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-fb08d78d"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/subPages/order/index.js.map
