  ...
  setup(__props) {
    ...
    const confirm = () => {
      ...
      pages_api_order.deleteOrder(baseData.value.id).then((res) => {
        ...
        common_vendor.index.__f__("log", "at subPages/order/details.vue:538", err);
        common_vendor.index.showToast({
          title: "删除失败",
          icon: "none",
          duration: 1e3
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-efbca6f1"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/subPages/order/details.js.map
