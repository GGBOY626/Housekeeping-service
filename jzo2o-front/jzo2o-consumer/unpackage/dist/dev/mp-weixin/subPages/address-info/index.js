  ...
  setup(__props) {
      ...
      if (!isConfirm.value) {
        ...
        if (editOrAdd.value === "add" && !id.value) {
          ...
          pages_api_address.addAddressBook(params).then((res) => {
            ...
            common_vendor.index.__f__("log", "at subPages/address-info/index.vue:318", err);
          });
          common_vendor.index.redirectTo({
            url: "/pages/address/index ?detailId=" + detailId.value
          });
    ...
    return (_ctx, _cache) => {
      return {
        ...
        r: common_vendor.n(isReset.value ? "active" : ""),
        s: common_vendor.o(submit),
        t: common_vendor.p({
          btnText: "确定",
          isActive: isConfirm.value
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-b08e797b"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/subPages/address-info/index.js.map
