  ...
  methods: {
    ...
    chooseFiles() {
      ...
      common_vendor.tr.chooseAndUploadFile({
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue:361", "选择失败", err);
      });
    },
    /**
     * 选择文件回调
    ...
    uploadFiles(files) {
      ...
      return uni_modules_uniFilePicker_components_uniFilePicker_chooseAndUploadFile.uploadCloudFiles.call(this, files, 5, (res) => {
        ...
        common_vendor.index.__f__("log", "at uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue:427", err);
      });
    },
    /**
     * 成功或失败
