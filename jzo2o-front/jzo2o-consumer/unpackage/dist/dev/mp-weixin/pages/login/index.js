...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const decryptPhoneNumber = (e) => {
      handleClose();
      common_vendor.index.__f__("log", "at pages/login/index.vue:120", e, "e");
    ...
    return (_ctx, _cache) => {
      return {
        ...
        g: common_vendor.o(decryptPhoneNumber),
        ...
        j: common_vendor.t(reason.value),
        k: common_vendor.o(handleClose),
        l: common_vendor.sr(alertDialog, "d08ef7d4-2", {
          "k": "alertDialog"
        }),
        m: common_vendor.p({
          type: "dialog",
