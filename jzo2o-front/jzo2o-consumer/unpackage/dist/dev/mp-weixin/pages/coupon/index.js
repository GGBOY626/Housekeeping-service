  ...
  setup(__props) {
    ...
    const getNewData = async () => {
      ...
      await pages_api_coupon.getCouponList(params.value).then((res) => {
        ...
        common_vendor.index.__f__("log", "at pages/coupon/index.vue:90", err);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-59672890"]]);
