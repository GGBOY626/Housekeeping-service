  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        o: common_vendor.unref(isManage)
      }, common_vendor.unref(isManage) ? {
        p: common_vendor.unref(isAllSelect),
        q: common_vendor.o(selectAll)
      } : {}, {
        r: common_vendor.unref(list).data.length > 0
      }, common_vendor.unref(list).data.length > 0 ? {
        s: common_vendor.t(common_vendor.unref(isManage) ? "完成" : "管理"),
        t: common_vendor.o(handleEdit)
      } : {}, {
        v: common_vendor.t(common_vendor.unref(isManage) ? "删除" : "新增地址"),
        w: common_vendor.n(common_vendor.unref(isManage) && common_vendor.unref(deleteIds).data.length || !common_vendor.unref(isManage) ? "active" : ""),
        x: common_vendor.o(handleDeleteOrAdd)
      }) : {
        y: common_vendor.p({
          handleToRefresh
        })
        ...
        C: common_vendor.sr(popup, "c47feaaa-3", {
          "k": "popup"
        }),
        D: common_vendor.p({
          type: "dialog",
