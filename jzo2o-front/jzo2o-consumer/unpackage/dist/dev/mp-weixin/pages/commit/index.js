  ...
  setup(__props) {
    ...
    const previewImage = (url, val) => {
      common_vendor.index.previewImage({
        ...
        urls: val,
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/commit/index.vue:145", "success", res);
        },
        fail: (err) => {
          common_vendor.index.__f__("log", "at pages/commit/index.vue:148", "fail", err);
        }
      });
    };
    const subDelete = () => {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        e: !isSendRequest.value
      }, !isSendRequest.value ? {} : {}, {
        f: common_vendor.s(common_vendor.unref(scrollHeight)),
        g: common_vendor.o(LoadMoreCustomers)
      }), {
        h: common_vendor.sr(deleteRef, "20907598-2", {
          "k": "deleteRef"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-20907598"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/commit/index.js.map
