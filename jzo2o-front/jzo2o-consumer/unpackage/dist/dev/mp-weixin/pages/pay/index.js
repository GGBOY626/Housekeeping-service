  ...
  setup(__props) {
    ...
    const getNative = async () => {
      ...
      await pages_api_order.payOrder(
        ...
        common_vendor.index.__f__("log", "at pages/pay/index.vue:162", err);
      });
    };
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        i: common_vendor.o(($event) => payChange(1)),
        j: common_vendor.o(($event) => radio1.value = $event),
        k: common_vendor.p({
          multiple: true,
        ...
        m: common_vendor.o(($event) => payChange(2)),
        n: common_vendor.o(($event) => radio2.value = $event),
        o: common_vendor.p({
          multiple: true,
          localdata: range.value,
          modelValue: radio2.value
        }),
        p: common_vendor.t((price.value - cheapPrice.value).toFixed(2)),
        q: common_vendor.o(getTradeImg)
      }) : {}, {
        r: qrCodeImg.value,
        s: common_vendor.o(handleClickPayResult),
        t: common_vendor.sr(popup, "d7fd7b38-3", {
          "k": "popup"
        }),
        v: common_vendor.p({
          ["is-mask-click"]: true,
