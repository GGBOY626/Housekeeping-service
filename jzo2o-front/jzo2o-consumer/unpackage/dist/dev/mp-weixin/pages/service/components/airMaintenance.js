  ...
  setup(__props) {
    ...
    const previewImage = (url, val) => {
      common_vendor.index.previewImage({
        ...
        urls: val,
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/service/components/airMaintenance.vue:345", "success", res);
        },
        fail: (err) => {
          common_vendor.index.__f__("log", "at pages/service/components/airMaintenance.vue:348", "fail", err);
        }
      });
    };
    const changeTab = (id) => {
    ...
    const getData = async (val) => {
      await pages_api_service.getServeById(val).then((res) => {
        ...
        common_vendor.index.__f__("log", "at pages/service/components/airMaintenance.vue:503", err);
      });
    };
    ...
    const handleSubmit = async (val) => {
      if (reNum.value > 1) {
        ...
        await pages_api_service.addOrder({
          ...
          common_vendor.index.__f__("log", "at pages/service/components/airMaintenance.vue:620", err);
          common_vendor.index.showToast({
            title: "请求异常",
            icon: "none",
            mask: true,
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        e: common_vendor.s(fixedBarStyle.value),
        ...
        p: common_vendor.f(data.value, (item, index, i0) => {
          ...
          return common_vendor.e({
            ...
            k: common_vendor.o(($event) => handleLike(1, item.id), index)
          } : {
            l: common_assets._imports_1$3,
            m: common_vendor.o(($event) => handleLike(0, item.id), index)
          }, {
            n: common_vendor.t(item.statistics.likeNumber),
            o: common_vendor.o(($event) => openReport(item.id), index),
            p: index
          });
        }),
        ...
        t: common_vendor.o(onPageScroll),
        v: common_vendor.s(scrollBoxHeight.value),
        w: scrollTop.value,
        x: common_vendor.o(LoadMoreCustomers),
        y: common_vendor.o(showPopup),
        z: common_vendor.o(handleCancel),
        A: common_vendor.f(common_vendor.unref(utils_commonData.reportList), (item, index, i0) => {
          return {
        ...
        C: common_vendor.sr(report, "ecebff2e-4", {
          "k": "report"
        }),
        D: common_vendor.p({
        ...
        G: !addressData.value.province
      }, !addressData.value.province ? {} : {}, {
        H: addressData.value
      }, addressData.value ? {
        I: common_vendor.t(addressData.value.province),
        J: common_vendor.t(addressData.value.city),
        K: common_vendor.t(addressData.value.country),
        L: common_vendor.t(addressData.value.address),
        M: common_vendor.t(addressData.value.name),
        N: common_vendor.t(addressData.value.phone)
      } : {}, {
        O: common_vendor.o(handleToAddress),
        P: common_assets._imports_4$1,
        Q: common_vendor.t(toDoorTimeLabel.value ? toDoorTimeLabel.value : "请选择"),
        R: common_vendor.n(toDoorTimeLabel.value ? "active" : ""),
        S: common_vendor.o(handleGetTime),
        T: common_assets._imports_5,
        U: couponList.value.length > 0
      }, couponList.value.length > 0 ? {
        V: common_vendor.t(activeCoupon.value.id ? `-${activeCoupon.value.discountAmount}元` : `${couponList.value.length}张可用`),
        W: common_vendor.n(((_f = activeCoupon.value) == null ? void 0 : _f.id) ? "active" : "")
      } : {}, {
        X: couponList.value.length <= 0
      }, couponList.value.length <= 0 ? {} : {}, {
        Y: common_vendor.o(handleGetCoupon),
        Z: couponList.value.length > 0
      }, couponList.value.length > 0 ? {
        aa: common_vendor.t((((_g = detailData.value) == null ? void 0 : _g.price) * number.value - (activeCoupon.value.discountAmount ? activeCoupon.value.discountAmount : 0)).toFixed(2))
      } : {}, {
        ab: couponList.value.length <= 0
      }, couponList.value.length <= 0 ? {
        ac: common_vendor.t(((_h = detailData.value) == null ? void 0 : _h.price) * number.value)
      } : {}, {
        ad: common_vendor.n(canSubmit.value ? "right agree-btn btn" : "right disabled-btn"),
        ae: common_vendor.o(($event) => {
          var _a2;
          return handleSubmit(((_a2 = detailData.value) == null ? void 0 : _a2.price) * number.value);
        }),
        af: common_vendor.sr(reservationBox, "ecebff2e-5", {
          "k": "reservationBox"
        }),
        ag: common_vendor.p({
          type: "bottom",
        ...
        ah: common_vendor.sr(timePicker, "ecebff2e-8", {
          "k": "timePicker"
        }),
        ai: common_vendor.o(getTime),
        aj: common_vendor.p({
          hour: hour.value
        }),
        ak: common_vendor.sr(coupons, "ecebff2e-9", {
          "k": "coupons"
        }),
        al: common_vendor.o(handleSelectCoupon),
        am: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-ecebff2e"]]);
_sfc_main.__runtimeHooks = 1;
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/service/components/airMaintenance.js.map
