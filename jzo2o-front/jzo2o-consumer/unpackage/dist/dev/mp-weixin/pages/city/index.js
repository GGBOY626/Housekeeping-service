  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        f: common_vendor.t(po_tips.value),
        g: common_vendor.o(getWarpWeft),
        h: hotCity.value.length > 0
        ...
        r: common_vendor.sr(operate, "5a18b3c9-1", {
          "k": "operate"
        }),
        s: common_vendor.o(setWarpWeft),
        t: common_vendor.p({
        ...
        w: common_vendor.t(scrollIntoId.value)
      } : {});
    };
  }
};
